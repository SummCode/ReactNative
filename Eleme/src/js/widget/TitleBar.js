...
import {Text, Image, View, StatusBar, TouchableOpacity, StyleSheet} from 'react-native';

import {width, unitWidth, titleHeight, statusBarHeight} from '../util/AdapterUtils'
...
export default class TitleBar extends React.Component {
    ...
    render() {
        const {backgroundColor, titleColor, navigation} = this.props;

        return (
            <View style={[TitleStyle.titleBar, backgroundColor ? {backgroundColor: backgroundColor} : 'white']}>
                <StatusBar
                ...
                <View style={TitleStyle.titleBarContent}>
                    {this.props.hideLeftArrow ? (<View style={TitleStyle.left}/>) : (
